                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw bold text-center mx-auto mx-2 ">
                                                    <a class="text-info  "
                                                        href="./uppatiente.php?id=<?= $val['CODEPATIENTE'] ?>">
            ...
            <div class="modal-dialog  ">
                <div class="modal-content border-bottom-dark">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title fw-bold " id="exampleModalLabel">Nouvelle Patiente</h5>
                        <button type="button" class="btn-close fw-bold text-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class="row g-3 form-horizontal mt-3" method="POST" action="./processing/addpatiente.php">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <label for="inputDate" class="col-sm-5 col-form-label fw-bold text-info">Date de
                                    Naissance</label>
                                <div class="col-sm-7">
                            ...
                            <div class="row mb-3">
                                <label for="inputText" class="text-info col-sm-3 col-form-label fw-bold">Etat
                                    Civil</label>
                                <div class="col-sm-9">
                            ...
                            <div class="row mb-3">
                                <label for="inputText"
                                    class="text-info col-sm-3 col-form-label fw-bold">Partenaire</label>
                                <div class="col-sm-9">
                            ...
                            <div class="row mb-3">
                                <label for="inputText"
                                    class="text-info col-sm-3 col-form-label fw-bold">Occupation</label>
                                <div class="col-sm-9">
                                    <input type="text" value="Aucune" class="form-control" name="occupation"
                                        required="">
                                </div>
                            </div>
