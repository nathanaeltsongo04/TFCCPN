            ...
            <div class="modal-dialog ">
                <div class="modal-content border-bottom-dark">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title fw-bold " id="exampleModalLabel">Nouvelle Fonction</h5>
                        <button type="button" class="btn-close fw-bold text-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class="row g-3 form-horizontal mt-3" method="POST" action="./processing/fonction.php">

                            <div class="col-12 mt-2 mb-3">
                                <input class="form-control" type="text" required="" name="fonction"
                                    placeholder="fonction" autocomplete="off">
                            </div>
