                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="card-header fw-bold border-bottom-0 mb-1 ">
                                    ...
                                    <?php echo ucfirst($pagename); ?> <span>| Liste</span>
            ...
            <div class="modal-dialog ">
                <div class="modal-content border-bottom-dark">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title fw-bold " id="exampleModalLabel">Nouvel Examen</h5>
                        <button type="button" class="btn-close fw-bold text-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class="row g-3 form-horizontal mt-3" method="POST" action="./processing/examen.php">

                            <div class="col-12 mt-2 mb-3">
                                <input class="form-control" type="text" required="" name="examen"
                                    placeholder="Désignation" autocomplete="off">
                            </div>
