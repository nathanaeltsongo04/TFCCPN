                                ...
                                <div class="card-body ">
                                    <div class="row mb-3 fw-bold ">
                                        <div class="col-sm-12 mb-1">
                                            ...
                                            <form method="POST" action="./processing/exapass.php">
                                                <input type="hidden" name="id" value="<?php echo $id ?>" />
                                                <div class="row mb-3">
                                                    <label for="Country" class="col-md-5 col-lg-4 col-form-label">Examen
                                                        :</label>
                                                    <div class="col-md-5 col-lg-6 mb-2">
                                                        <select required="" name="examen" id="inputState"
                                                            class="form-select">
                                                            <option name="examen" selected>Choose...</option>
                                                            <?php
                                                        foreach ($allf as $cle => $valeur) { ?>
                                                            <option value="<?= $valeur['CODEEXAMEN'] ?>">
                                                                <?= $valeur['DESIGNATION'] ?>
                                                            </option>
                                                            <?php } ?>
