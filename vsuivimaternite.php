  ...
  ======================================================== -->
    ...
    <body>
        ...
        Swal.fire({
            ...
            location.replace('vsuivimaternite.php?id=<?php echo $id ?>');
                                ...
                                <div class="card-body ">
                                    <div class="row mb-3 fw-bold ">
                                        <div class="col-sm-12 mb-1">
                                            ...
                                            <form method="POST"
                                                action="./upsuivimaternite.php?code=<?= $vals['CODEMAT'] ?>&id=<?php echo $id ?>">
                                                <input type="hidden" name="code" value="<?= $vals['CODEMAT'] ?>" />
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-md-7 col-lg-8">
                                                        <input name="autre" type="text"
                                                            ...
                                                            value="<?= $vals['EXAPHYSIQUE'] ?>" disabled>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <label for="Country" class="col-md-5 col-lg-4 col-form-label">Examen
                                                    ...
                                                    <div class="col-md-7 col-lg-8">
                                                        <input name="autre" type="text"
                                                            class="form-control border-0 bg-white" id="Country"
                                                            value="<?= $vals['EXAPARACLINIQUE'] ?>" disabled>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-md-7 col-lg-8">
                                                        <textarea required="" name="autrobs"
                                                            class="form-control bg-white border-0" id="about"
                                                            style="height: 100px"
                                                            disabled> <?= $vals['AUTROBS'] ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <label for="Country"
                                                    ...
                                                    <div class="col-md-7 col-lg-8">
                                                        <input name="autre" type="text"
                                                            class="form-control border-0 bg-white" id="Country"
                                                            value="<?= $vals['CONCLUSION'] ?>" disabled>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <label for="Country"
