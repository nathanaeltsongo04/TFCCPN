...
$data = new planning();
$data->setDATERDV(date('Y-m-d'));
$all = $data->afficherByrefpatiente();
?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <table class="table datatable table-responsive">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw bold">
                                                    <?php
                                                    if ($_SESSION['fonction'] == "Médecin" || $_SESSION['fonction'] == "Femme Sage" || $_SESSION['fonction'] == "Administrateur") {
                                                    ?>
                                                    <a class="text-secondary ms-5"
                                                        href="./doctor.php?id=<?= $val['codepatiente'] ?>">
                                                        <i class="fa-solid fa-user-doctor fa-xl"></i>
                                                    </a>
                                                    <a class="text-secondary ms-3"
                                                        href="./fiche.php?id=<?= $val['codepatiente'] ?>">
