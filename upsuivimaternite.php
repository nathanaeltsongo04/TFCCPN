                                ...
                                <div class="card-body ">
                                    <div class="row mb-3 fw-bold ">
                                        <div class="col-sm-12 mb-1">
                                            ...
                                            <form method="POST"
                                                action="./processing/upsuivimaternite.php?code=<?= $vals['CODEMAT'] ?>&id=<?php echo $id ?>">
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-md-7 col-lg-8">
                                                        <textarea required="" name="autrobs" class="form-control"
                                                            id="about"
                                                            style="height: 100px"><?= $vals['AUTROBS'] ?> </textarea>
