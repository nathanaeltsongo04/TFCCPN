                    ...
                    <div class="col-12">
                        <div class="card recent-sales overflow-auto">
                            ...
                            <div class="card-header fw-bold border-bottom-0 mb-1 ">
                                ...
                                Modification <span>| Fonction</span>
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                    <form class="row g-3 form-horizontal mt-3" method="POST" action="./processing/upfonction.php?id=<?php echo $id ?>">
                                        <input type="hidden" name="id" value="<?php echo $id ?>" />
                                        <div class="row mb-3">
                                            <label for="inputText" class=" col-sm-3 col-form-label fw-bold">Fonction</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?= $val['DESIGNATION'] ?>" type="text" required="" name="fonction" autocomplete="off">
                                            </div>
                                        </div>
