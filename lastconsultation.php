                        ...
                        <div class="card recent-sales overflow-auto">
                            ...
                            <div class="card-body ">
                                <div class="row mb-3 fw-bold ">
                                    ...
                                    <form method="POST" action="./processing/addlastconsult.php">
                                        ...
                                        <table class="table table-borderless ">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="col-md-4 col-lg-5">
                                                            <select required="" name="conj" id="inputState" class="form-select">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="col-md-6 col-lg-7">
                                                            <input step="0.1" required="" min="0" name="huterine" type="number" class="form-control" id="Country" value="0.0">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="col-md-4 col-lg-5">
                                                            <select required="" name="btf" id="inputState" class="form-select">
                                                                <option selected>Choose...</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="col-md-4 col-lg-5">
                                                            <select required="" name="eodem" id="inputState" class="form-select">
                                                                <option selected>Choose...</option>
                                                                <option value="Absent">Absent</option>
                                                                <option value="Présent">Présent</option>
                                                            </select>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="col-md-4 col-lg-5">
                                                            <select required="" name="albuminurie" id="inputState" class="form-select">
                                                                <option selected>Choose...</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="col-md-6 col-lg-7">
                                                            <input required="" name="ta" type="text" class="form-control" id="Country" value="">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="col-md-6 col-lg-7">
                                                            <input name="autreapreciser" type="text" class="form-control" id="Country" value="">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="col-md-4 col-lg-5">
                                                            <select required="" name="concentraction" id="inputState" class="form-select">
                                                                <option selected>Choose...</option>
                                                                <option value="Positif(ve)">Positif(ve)</option>
                                                                <option value="Négatif(ve)">Négatif(ve)</option>
